...
switch ($method) {
    ...
    case 'POST':
        ...
        // FIXED: Correct type string - 11 parameters total
        ...
        if ($stmt->execute()) {
            ...
            echo json_encode(['success' => false, 'message' => 'Failed to add medicine.', 'error' => $stmt->error]);
        }
        break;
    ...
    case 'PUT':
        ...
        // FIXED: Correct type string - 13 parameters total
        $stmt->bind_param(
            'ssiiisiissssi',
            $body['name'],
            $body['generic_name'],
